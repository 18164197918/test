(function () {
	 ...
	 CKEDITOR.plugins.add('baiduMap',{  
		 ...
		 init: function(editor){
		 	var pluginName = 'baiduMap';
		 	 CKEDITOR.dialog.add(pluginName, this.path + 'dialogs/baiduMap.js');
		 	editor.addCommand(pluginName, new CKEDITOR.dialogCommand(pluginName));//
		 	 editor.ui.addButton(pluginName, {  
                label: '百度地图',//调用dialog时显示的名称  
                command: pluginName,  
                icon: CKEDITOR.plugins.getPath('baiduMap') + 'baiduMap.png'
//              icon:CKEDITOR.plugins.getPath('baiduMap') + 'g.ico'
//				click:function(e){
//					
//			  		 	
//			  		 	
